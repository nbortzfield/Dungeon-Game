...
#ifndef M2OEP_ZRUE_ROOM_TREASURE_H
#define M2OEP_ZRUE_ROOM_TREASURE_H
#include "Room.h"

class Room_Treasure : public Room {
public:
    /**
     * Requires: nothing
     ...
     */
    explicit Room_Treasure(int proomNumber);
     ...
     */
    explicit Room_Treasure(int proomNumber, string ptype, double pthreatlevel, int ptreasure, string ptrapsn, int pdoors, int pX, int pY);
...
#endif //M2OEP_ZRUE_ROOM_TREASURE_H
